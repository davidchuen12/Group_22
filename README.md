...
- We assume the number of people leaving(release the table) should always equal to the number of people when they occupy the table. It means a group of 3 people occupying table 1 when they come, if they left, 3 people should leave together but not leaving their friend here.
